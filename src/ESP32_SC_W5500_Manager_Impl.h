...
#ifndef ESP32_SC_W5500_Manager_Impl_h
#define ESP32_SC_W5500_Manager_Impl_h
...
/**
   ...
   @access public
*/
ESP32_EMParameter** ESP32_SC_W5500_Manager::getParameters()
{
  return _params;
}
...
/**
   ...
   @access public
*/
int ESP32_SC_W5500_Manager::getParametersCount()
{
  return _paramsCount;
}
...
char* ESP32_SC_W5500_Manager::getRFC952_hostname(const char* iHostname)
{
...
ESP32_SC_W5500_Manager::ESP32_SC_W5500_Manager(const char *iHostname)
{
...
#if USE_DYNAMIC_PARAMS
  bool ESP32_SC_W5500_Manager::addParameter(ESP32_EMParameter *p)
#else
  void ESP32_SC_W5500_Manager::addParameter(ESP32_EMParameter *p)
#endif
{
#if USE_DYNAMIC_PARAMS
...
void ESP32_SC_W5500_Manager::setupConfigPortal()
{
  ...
  server->on("/",         std::bind(&ESP32_SC_W5500_Manager::handleRoot,         this));
  server->on("/eth",      std::bind(&ESP32_SC_W5500_Manager::handleETH,          this));
  server->on("/ethsave",  std::bind(&ESP32_SC_W5500_Manager::handleETHSave,      this));
  server->on("/close",    std::bind(&ESP32_SC_W5500_Manager::handleServerClose,  this));
  server->on("/i",        std::bind(&ESP32_SC_W5500_Manager::handleInfo,         this));
  server->on("/r",        std::bind(&ESP32_SC_W5500_Manager::handleReset,        this));
  server->on("/state",    std::bind(&ESP32_SC_W5500_Manager::handleState,        this));
  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
  server->on("/fwlink",   std::bind(&ESP32_SC_W5500_Manager::handleRoot,         this));
  server->onNotFound(     std::bind(&ESP32_SC_W5500_Manager::handleNotFound,     this));
...
bool ESP32_SC_W5500_Manager::startConfigPortal()
{
  connect = false;
...
void ESP32_SC_W5500_Manager::setTimeout(const unsigned long& seconds)
{
...
void ESP32_SC_W5500_Manager::setConfigPortalTimeout(const unsigned long& seconds)
{
...
void ESP32_SC_W5500_Manager::setConnectTimeout(const unsigned long& seconds)
{
  _connectTimeout = seconds * 1000;
}

void ESP32_SC_W5500_Manager::setDebugOutput(bool debug)
{
  _debug = debug;
}
...
void ESP32_SC_W5500_Manager::setBreakAfterConfig(bool shouldBreak)
{
...
void ESP32_SC_W5500_Manager::reportStatus(String& page)
{
...
void ESP32_SC_W5500_Manager::setSTAStaticIPConfig(const IPAddress& ip, const IPAddress& gw, const IPAddress& sn)
{
...
void ESP32_SC_W5500_Manager::setSTAStaticIPConfig(const ETH_STA_IPConfig& EM_STA_IPconfig)
{
  LOGINFO(F("setSTAStaticIPConfig"));
...
void ESP32_SC_W5500_Manager::getSTAStaticIPConfig(ETH_STA_IPConfig& EM_STA_IPconfig)
{
...
void ESP32_SC_W5500_Manager::handleRoot()
{
...
void ESP32_SC_W5500_Manager::handleETH()
{
...
void ESP32_SC_W5500_Manager::handleETHSave()
{
  LOGDEBUG(F("ETH save"));
...
void ESP32_SC_W5500_Manager::handleServerClose()
{
...
void ESP32_SC_W5500_Manager::handleInfo()
{
  LOGDEBUG(F("Info"));
  ...
  page += F("<p/>More information about ESP32_SC_W5500_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/ESP32_SC_W5500_Manager\">https://github.com/khoih-prog/ESP32_SC_W5500_Manager</a>");
  page += FPSTR(EM_HTTP_END);
...
void ESP32_SC_W5500_Manager::handleState()
{
...
void ESP32_SC_W5500_Manager::handleReset()
{
  LOGDEBUG(F("Reset"));
...
void ESP32_SC_W5500_Manager::handleNotFound()
{
  if (captivePortal())
  {
...
*/
bool ESP32_SC_W5500_Manager::captivePortal()
{
...
void ESP32_SC_W5500_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void ESP32_SC_W5500_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool ESP32_SC_W5500_Manager::isIp(const String& str)
{
...
// IP to String
String ESP32_SC_W5500_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // ESP32_SC_W5500_Manager_Impl_h
