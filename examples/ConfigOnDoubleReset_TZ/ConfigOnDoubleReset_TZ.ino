...
void setup()
{
  ...
  Serial.println(ESP32_SC_W5500_MANAGER_VERSION);
  ...
  ESP32_SC_W5500_Manager ESP32_SC_W5500_manager("ConfigOnDoubleReset_TZ");

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  ESP32_SC_W5500_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //ESP32_SC_W5500_manager.setConfigPortalTimeout(600);
